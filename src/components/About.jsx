...
const About = () => {
  ...
  return (
    <section id="about" className="bg-[#0B0C10] pt-20 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans border-b border-white/5">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-b from-[#ff416c]/10 to-transparent rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start relative z-10">
        ...
        <div className="flex flex-col items-center w-full md:w-[350px] shrink-0 mt-12 md:mt-0 relative">
          ...
          <div data-aos="drop-bounce" className="relative flex justify-center w-full">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-64 bg-gradient-to-r from-[#ff416c] to-[#ff4b2b] rounded-[100px] blur-[80px] opacity-40 z-0 animate-pulse"></div>
        ...
        <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-white mt-8 md:mt-0 relative z-20">
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md shadow-xl mb-8 hover:border-white/20 hover:shadow-[0_0_30px_rgba(255,65,108,0.1)] transition-all duration-300">
            <p className="text-lg font-medium mb-6 leading-relaxed max-w-3xl text-gray-300">
              Hi, my name is <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#ff416c] to-[#ff4b2b] text-2xl font-black mx-1 tracking-wide uppercase">Latheesh</span>. I am a B.Tech graduate in Electrical and Electronics Engineering from Sri Venkateswara University (2026), currently working as a <span className="text-white font-semibold">Programmer Intern at Business Data AI</span>.
            </p>
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md shadow-xl mb-8 hover:border-white/20 hover:shadow-[0_0_30px_rgba(255,65,108,0.1)] transition-all duration-300 group">
            <h3 className="text-2xl font-outfit font-black text-white mb-6 flex items-center gap-3">
              <span className="w-8 h-1.5 bg-gradient-to-r from-[#ff416c] to-[#ff4b2b] rounded-full group-hover:w-12 transition-all duration-300"></span>
              Education
            </h3>
            <div className="space-y-6">
              <div className="border-l-2 border-[#ff416c] pl-5 relative">
                <div className="absolute -left-[5px] top-2 w-2 h-2 bg-[#ff416c] rounded-full shadow-[0_0_10px_#ff416c]"></div>
                <h4 className="text-xl font-bold text-white tracking-tight">B.Tech - Electrical & Electronics Engineering</h4>
                <p className="text-sm font-medium text-gray-400 mt-1">Sri Venkateswara University, Tirupati | GPA: 6.5/10 <span className="text-[#ff4b2b] font-bold ml-2">(2022 - 2026)</span></p>
              </div>
            ...
            <div className="space-y-3">
              {certifications.map((cert, i) => (
                <div key={i} className="flex items-start gap-3 text-sm">
                  <svg className="w-4 h-4 text-[#ff416c] mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 24 24"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"/></svg>
                  <div>
                    <span className="text-white font-semibold">{cert.title}</span>
                    <span className="text-gray-400"> — {cert.org}</span>
                    {cert.year && <span className="text-[#ff4b2b] font-bold ml-2">({cert.year})</span>}
                  </div>
                </div>
              ))}
            </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['JavaScript (ES6+)', 'Python', 'SQL'].map((s) => (
                    <span key={s} className="px-4 py-2 bg-white/[0.04] text-gray-200 border border-white/[0.08] text-sm font-bold rounded-xl hover:bg-[#ff416c]/15 hover:text-[#ff6b9d] hover:border-[#ff416c]/30 transition-all duration-300 cursor-default">{s}</span>
                  ))}
                </div>
              </div>
              <div>
      ...
      <div className="absolute top-10 right-10 md:right-20 text-[#ff416c] opacity-20 animate-pulse">
      ...
      <div className="absolute bottom-20 left-4 md:left-20 text-[#ff4b2b] opacity-20 animate-pulse" style={{ animationDelay: '1s' }}>
