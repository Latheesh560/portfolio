...
const Footer = () => {
  return (
    <footer className="bg-[#0B0C10] text-[#C5C6C7] py-16 px-6 md:px-12 w-full font-mono text-[10px] md:text-xs tracking-widest flex flex-col justify-between min-h-[50vh] border-t border-white/5 relative overflow-hidden">
      ...
      {/* Ambient glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-gradient-to-t from-[#00ffcc]/5 to-transparent blur-[100px] pointer-events-none"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 w-full font-medium relative z-10">
        ...
        <div className="flex flex-col gap-1.5 md:items-center">
          ...
          <a href="#projects" className="inline-flex items-center gap-1 underline hover:text-[#00ffcc] transition-colors mt-1 underline-offset-4 decoration-1 group">
            View Projects
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 w-full items-end font-medium relative z-10">
        <div className="flex flex-col gap-4">
          <a href="#contact" className="inline-flex items-center gap-2 text-white hover:text-[#00ffcc] transition-colors font-bold group">
        ...
        <div className="flex flex-col gap-3 md:items-center">
          <a href="mailto:latheeshvalmeti226@gmail.com" className="hover:text-[#00ffcc] transition-colors lowercase">latheeshvalmeti226@gmail.com</a>
          <div className="flex gap-4 mt-1">
            <a href="https://linkedin.com/in/valmeti-latheesh" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#00ffcc] transition-all duration-300 hover:scale-110">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </a>
            <a href="https://github.com/Latheesh560" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#00ffcc] transition-all duration-300 hover:scale-110">
        ...
        <div className="flex flex-col gap-1 md:items-end">
          <a href="#home" className="hover:text-[#00ffcc] transition-colors group inline-flex items-center gap-2 font-bold">
            Back to Top
